...
public class EmailUtils {  
    ...
    public boolean sendTemplateMail(String subject,String email){
    	Map<String,Object> root=new HashMap<String, Object>();
    	return sendTemplateMail(root, subject,email);
    }
     ...
     * @return 
     */  
    public boolean sendTemplateMail(Map<String,Object> root,String subject,String email){    
        try {  
